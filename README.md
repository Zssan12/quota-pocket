...
**不想操作终端？** 复制[给本地 Agent 的安装提示词](AGENT-INSTALL.md)，交给能操作这台 Mac 的 Codex、Claude Code、WorkBuddy 等工具。它可以帮你检查环境、安装项目并打开配置网页；账户登录和手机操作由你完成。
...
- [让本地 Agent 帮你安装](AGENT-INSTALL.md)
