...
Read README.en.md and, on Windows, docs/WINDOWS.md. Check Python 3.9+ and Node.js 20+; reuse existing tools and explain any missing prerequisites.
...
An existing Mac installation is not automatically upgraded; check docs/MAC.md.

Verify the local setup page opens. Let me choose sources and authorize through official pages. Guide me through confirming quotas, enabling my iCloud, installing Scriptable from https://apps.apple.com/app/scriptable/id1405459188 and running the generated script and adding a widget. Compare collection timestamps; a computer write is not proof of phone delivery.
